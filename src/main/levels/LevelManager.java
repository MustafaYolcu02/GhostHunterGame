...
public class LevelManager {
    ...
    // Her level için farklı arkaplan resmini tek yerden verir.
    private String background(int levelNumber) {
        if (levelNumber == 2) return "level2.png";
        if (levelNumber == 3) return "level3.png";
        return "level1.png";
    }
}
