...
public class Main extends Application {
    ...
    private void startGame(Stage primaryStage, int levelNumber) {
        ...
        root = new Pane();
        ImageView background = new ImageView(new Image("file:resources/levelBackgrounds/" + currentLevel.getBackground()));
        ...
        root.getChildren().addAll(background, playableAreaBorder);
    ...
    private void update(long now, Stage stage) {
        ...
        if (mouseX != 0 || mouseY != 0) {
            hunter.rotateScanner(mouseX, mouseY);
        }
    }
    ...
    private void updateEntities(Stage stage) {
        ...
        long currentTime = System.nanoTime(); // Anlık zamanı al
